...
SELECT * 
 ...
 order by 1,2,3
-- SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_TYPE = 'PROCEDURE'  AND  SPECIFIC_CATALOG='JDE_CRP' order by 1,2,3 asc
...
WHERE pr.Is_MS_Shipped = 0 AND pr.name LIKE '%_nuevo_numero_de_folio' 
...
SELECT @table_name = 'CRPDTA.F0911'
